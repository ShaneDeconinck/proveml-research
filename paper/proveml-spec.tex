...
\title{\textbf{ProveML: Inline Claim Markup for Deterministic Verification of Open-Ended AI Generation}}
...
\begin{enumerate}
    ...
    \item \textbf{A reference implementation} with 144 tests (plugin, grammar, paper-example, and skill checks), tested against both a synthetic educational dataset and real SEC EDGAR financial data (Section 9).
\end{enumerate}
...
\begin{itemize}
    ...
    \item Test suite: 144 tests (76 plugin, 32 grammar, 16 paper examples, 20 skills)
...
\noindent Tested using a fully synthetic dataset inspired by a secondary school assessment context. All data is fabricated and does not correspond to real individuals or institutions. The reference implementation and test suites are publicly available at \url{https://github.com/ShaneDeconinck/proveml}. The repository includes a reference audit page that applies ProveML verification to this paper's own citations against curated source passages.
