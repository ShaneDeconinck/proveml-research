...
The through-line of the evaluation (Section~\ref{sec:evaluation}) is that the capability threshold tracks the shape of the request --- schema size, prompt language, context selection --- rather than the size of the model, with the architecture, verifier and grammar unchanged across every condition.
