...
Ablations (full-context and English-prompt; Section 7.3 of the paper) resume-safely:
...
SymGen baseline (Section 7.6 of the paper), resume-safe like the ablations:
...
Markup coverage audit (Section 7.7 of the paper) over the stored final responses:
