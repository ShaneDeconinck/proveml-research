...
\begin{enumerate}
    ...
    \item \textbf{Qwen 3B, Haiku and Qwen 7B} sit together at 88--89\% first-pass verification and stay there: the widest between-run spread is Qwen 7B's $\pm$ 4.9, the narrowest Qwen 3B's $\pm$ 1.2. Addressability errors dominate their residuals (75--82\%). They differ in how much they say rather than how reliably: Qwen 7B converges on the most queries (23 of 28) while producing the fewest claims ($\approx$100 per run against Haiku's $\approx$172), so its lead in convergence partly reflects a shorter answer with less to get wrong.
\end{enumerate}
