...
\begin{enumerate}
    ...
    \item \textbf{A reference implementation} with 197 tests (plugin, grammar, paper-example, CLI, and detection checks), tested against both a generated educational dataset and real SEC EDGAR financial data (Section~\ref{sec:implementation}).
\end{enumerate}
